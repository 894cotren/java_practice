...
public class StreamPracticeData {
    ...
    public static List<Order> orderList = Arrays.asList(
            new Order(1001L, 1L, new ArrayList<Long>(Arrays.asList(101L, 103L)), LocalDateTime.of(2024, 3, 15, 10, 30), new BigDecimal("7098")),
            new Order(1002L, 2L, new ArrayList<Long>(Arrays.asList(107L, 104L)), LocalDateTime.of(2024, 4, 2, 14, 15), new BigDecimal("5198")),
            new Order(1003L, 3L, new ArrayList<Long>(Arrays.asList(105L, 106L)), LocalDateTime.of(2024, 3, 28, 9, 40), new BigDecimal("103")),
            new Order(1004L, 5L, new ArrayList<Long>(Arrays.asList(102L)), LocalDateTime.of(2024, 4, 10, 16, 20), new BigDecimal("5999")),
            new Order(1005L, 8L, new ArrayList<Long>(Arrays.asList(108L, 103L)), LocalDateTime.of(2024, 3, 5, 11, 5), new BigDecimal("498")),
            new Order(1006L, 4L, new ArrayList<Long>(Arrays.asList(101L, 107L)), LocalDateTime.of(2024, 4, 15, 18, 30), new BigDecimal("11998")),
            new Order(1007L, 6L, new ArrayList<Long>(Arrays.asList(104L, 106L)), LocalDateTime.of(2024, 3, 20, 15, 10), new BigDecimal("234")),
            new Order(1008L, 7L, new ArrayList<Long>(Arrays.asList(103L, 105L)), LocalDateTime.of(2024, 4, 8, 12, 25), new BigDecimal("167"))
    );
}
